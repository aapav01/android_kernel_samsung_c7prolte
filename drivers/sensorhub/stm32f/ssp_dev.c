...
int c5_project[7] = {-730, 970, -1370, 1000, 1006, 5730, -132};
	...
	struct ssp_data *data)
{
	...
	if(of_property_read_u32(np, "ssp-project-select", &data->project_select))
		data->project_select = 5;
...
static int ssp_suspend(struct device *dev)
{
	...
	ssp_errf("MSG2SSP_AP_STATUS_SUSPEND END");
...
static int ssp_resume(struct device *dev)
{
	...
	ssp_errf("MSG2SSP_AP_STATUS_RESUME END");
